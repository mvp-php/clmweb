                                ...
                                <div class="input_pd2 pt-4">
                                    <div class="col-xl-12 col-12">
										...
										?>
                                            ...
                                            <input type="text" min="0" name="usrname" class="form-group w-100" placeholder="Morning- 10:30- 11:30" value="<?php echo $session.' '.date('h:i',strtotime($row['start_time'])).'-'.date('h:i',strtotime($row['end_time'])); ?>" >
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-12 pt-5">
                                            ...
                                            <div class="col-xl-6 col-12">
												...
												<?=$row['address1'].' '.$row['address2'].' '.$row['city_name'].' '.$row['postcode'].' '.$row['state_fk'].' '.$row['country_name']?>
                                                </p>
                                            </div>
