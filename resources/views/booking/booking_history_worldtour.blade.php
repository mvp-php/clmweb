        ...
        <div class="container pt-lg-5">
            <div class="row row_cstm agileinfo_mail_grids">
                <div class="col-xl-12 col-lg-12 col-md-12 mt-lg-0 mt-4 p-0">
                    <div class="prc_box">
                        <div class="pr_cptn">
                            <h1 class="pr_caption">My Bookings History</h1>
                        </div>
                        <div class="cstm_input">
                            <ul class="unstyled centered">
                               <li>
										<a href="{{ URL::to('my-booking-history-outlet') }}"><button class="button btn-red-cstm Muli-Bold pd_cstm w-250" >Outlet</button></a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('my-booking-history-worldtour') }}"><button class="button btn-red-cstm Muli-Bold pd_cstm w-250" >Work Tour</button></a>
                                </li>
                            </ul>
                        </div>
						<?php if(count($world_tour) != 0){ foreach($world_tour as $row){ ?>
                        <a href="{{ URL::to('booking-detail-worltour') }}/<?=$row->id?>"><div class="pr_b2">
                            <div class="row" id="booking_clm_id">
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 text-center">
                                    <div class="pr_text_box">
                                        <p class="Muli-Bold pr_t1 mb-0">World Tour</p>
                                        <p class="pr_t2"><?php
												echo $row->tour_name;
										?></p>
                                    </div>
